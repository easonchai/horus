...
New code should import directly from horus.core.agent_kit instead.
"""
...
warnings.warn(
    "Importing from horus.tools.agent_kit is deprecated and will be removed in a future version. "
    "Import from horus.core.agent_kit instead.",
    DeprecationWarning,
    stacklevel=2
)

# Re-export everything from core.agent_kit
from horus.core.agent_kit import (AGENTKIT_AVAILABLE, ActionResult,
